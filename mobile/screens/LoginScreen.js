        ...
        {mode === "login" ? (
          ...
          <>
            ...
            <View style={styles.inputRow}>
              ...
              <TextInput placeholder="Gender (M/F)" value={gender} onChangeText={setGender} style={styles.input} maxLength={1} autoCapitalize="characters" />
            </View>

            <View style={styles.inputRow}>
              <Ionicons name="calendar-outline" size={20} color="#555" />
              <TextInput placeholder="Year (1-4)" value={year} onChangeText={setYear} style={styles.input} keyboardType="number-pad" maxLength={1} />
            </View>

            <View style={styles.inputRow}>
              <Ionicons name="school-outline" size={20} color="#555" />
              <TextInput placeholder="Roll Number" value={rollNo} onChangeText={setRollNo} style={styles.input} autoCapitalize="none" />
            </View>

            <View style={styles.inputRow}>
              <Ionicons name="mail-outline" size={20} color="#555" />
              <TextInput placeholder="asingh19_be23@thapar.edu" value={email} onChangeText={setEmail} style={styles.input} autoCapitalize="none" keyboardType="email-address" />
            </View>

            <View style={styles.inputRow}>
              <Ionicons name="lock-closed-outline" size={20} color="#555" />
              <TextInput placeholder="Create password" value={password} onChangeText={setPassword} style={styles.input} secureTextEntry />
            </View>
